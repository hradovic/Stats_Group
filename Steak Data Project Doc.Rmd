...
```{r}
glm_incomegamble <- glm(steak_prep_rare ~ hhold_income + gamble, data = steak_survey, family = binomial(link = "logit"))
...
glm_incomegamble %>%
  ggplot()+
  geom_count(mapping = aes(x = hhold_income, y = steak_prep_rare))
```
